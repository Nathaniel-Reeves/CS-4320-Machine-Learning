...
def parse_args(argv):
    ...
    parser.add_argument('--model-type',    '-M', default="SGD", type=str,   choices=["SGD", "linear", "SVM", "boost", "forest", "tree", "knn", "SGDc", "logistic"], help="Model type") # "knn", "SGDc"
    ...
    parser.add_argument('--model-file',    '-m', default="out/model",    type=str,   help="name of file for the model (default is constructed from train file name when fitting)")
    ...
    parser.add_argument('--features',      '-f', default=None, action="extend", nargs="+", type=str,help="column names for features")
    ...
    parser.add_argument('--image-file',          default="out/image.png", type=str,   help="name of file to store output images")
    ...
    elif my_args.model_type in ("SVM", "boost", "forest", "tree", "knn", "SGDc", "logistic"):
