...
def histogram_all(data, feature_names, label_name, orientation, figure_name="histograms.png"):
    """
...
def main():
    ...
    histogram_all(data, feature_names, label_name, orientation)
    scatter_all(data, feature_names, label_name, orientation)
    return
